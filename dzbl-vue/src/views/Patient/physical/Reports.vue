  ...
  <div class="physical-reports">
    <el-card class="reports-card">
      ...
      <el-form :inline="true" :model="queryForm" class="search-form">
        <el-form-item label="体检ID">
          <el-input v-model="queryForm.examId" placeholder="请输入体检ID" clearable />
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="体检结果" min-width="200">
